...
- CI does **not** run on untrusted/fork PRs until a **maintainer** adds the label `ci:run` after reviewing the diff.
- Same-repo PRs from maintainers (`OWNER` / `MEMBER` / `COLLABORATOR`) run CI automatically.
